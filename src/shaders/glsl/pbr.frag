...
void main()
{
    ...
    for(uint LightIndex = 0; LightIndex < u_AnalyticalLightCount; ++LightIndex)
    {
        vec3 Li = -u_AnalyticalLights[LightIndex].Direction;
		vec3 Lradiance = u_AnalyticalLights[LightIndex].Radiance;
...

    {
     ...
     //vec3 AmbientLighting = Albedo * AmbientOcclusion;
